...
function ScriptInit()
	...
	ReadDataFile("dc:SIDE\\rep.lvl",
		"rep_inf_ep3_rifleman_shiny",
		"rep_inf_ep3_rocketeer_shiny",
		"rep_inf_ep3_sniper_shiny",
	...
	SetupTeams{
		REP = {
			...
			units = 32,
			reinforcements = -1,
			soldier = { "rep_inf_ep3_rifleman_shiny",9, 25},
			assault = { "rep_inf_ep3_rocketeer_shiny",1, 4},
			engineer = { "rep_inf_ep3_engineer_pilot", 1, 4},
			sniper  = { "rep_inf_ep3_sniper_shiny",1, 4},
